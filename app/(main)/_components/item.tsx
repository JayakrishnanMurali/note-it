...
import { ChevronRight, ChevronsDown, LucideIcon, Plus } from "lucide-react";
...
Item.skeleton = function ItemSkeleton({ level }: { level?: number }) {
  return (
    ...
    >
      <Skeleton className="h-4 w-4 bg-neutral-300 dark:bg-neutral-600" />
      <Skeleton className="h-4 w-[70%] bg-neutral-300 dark:bg-neutral-600" />
    </div>
  );
};
